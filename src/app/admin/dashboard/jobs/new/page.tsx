  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">New Job</h1>
          <p className="text-gray-500 dark:text-gray-400 mt-1">Post a new job opening</p>
        </div>
      </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-6 md:p-8 space-y-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <label htmlFor="featured" className="text-sm font-medium text-gray-700 dark:text-gray-300">
              Featured job (appears prominently)
            </label>
          </div>
        </div>
